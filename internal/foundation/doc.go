...
//
// This package contains the foundational building blocks used throughout
// the AE-ADK system, including:
//
...
// and the pkg/models package for shared DevelopmentMode types.
package foundation
