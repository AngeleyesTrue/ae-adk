...
const profilesDir = ".ae/claude-profiles"

// BaseDirOverride allows tests to inject a custom base directory.
// When non-empty, GetBaseDir returns this value instead of ~/.ae/claude-profiles.
var BaseDirOverride string

// GetBaseDir returns ~/.ae/claude-profiles/.
...
func Delete(name string) error {
	...
	if currentProfile == name {
		...
		fmt.Fprintf(os.Stderr, "Run: ae cc (without -p) to use default\n")
	}
