...
- `ae-domain-backend` - REST API and microservices architecture
- `ae-domain-database` - SQL patterns and query optimization
- `ae-workflow-testing` - DDD and testing strategies
- `ae-essentials-debug` - AI-powered debugging
- `ae-platform-deploy` - Deployment and infrastructure
