...
description: >
  ...
  Do NOT use for refactoring existing code (use ae-workflow-ddd instead)
...
metadata:
  ...
  context: "fork"
  agent: "manager-tdd"
  related-skills: "ae-workflow-ddd, ae-workflow-testing, ae-foundation-quality"
...
- `development_mode: ddd` → Use DDD instead (ae-workflow-ddd)
