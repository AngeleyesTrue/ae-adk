---
name: ae-foundation-philosopher
description: >
  ...
  Do NOT use for code quality validation (use ae-foundation-quality instead)
  or implementation workflows (use ae-workflow-ddd instead).
license: Apache-2.0
...
- Apply Assumption Audit during /ae:1-plan
...
Skills:
- ae-foundation-core: Integration with TRUST 5 and SPEC workflow
- ae-workflow-spec: Assumption documentation in SPEC format
- ae-domain-backend: Technology-specific trade-off criteria
- ae-domain-frontend: UI/UX decision frameworks

Commands:
- /ae:1-plan: Apply Philosopher Framework during specification
- /ae:2-run: Reference documented trade-offs during implementation
