...
- ae-lang-java - JVM interoperability, Spring Boot integration
- ae-domain-backend - REST API, GraphQL, microservices patterns
- ae-domain-database - Doobie, Slick, database patterns
- ae-workflow-testing - ScalaTest, MUnit, property-based testing
