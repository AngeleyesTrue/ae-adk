...
description: >
  ...
  Do NOT use for architecture decisions (use ae-foundation-philosopher instead)
  or code quality validation (use ae-foundation-quality instead).
license: Apache-2.0
...
metadata:
  ...
  related-skills: "ae-foundation-philosopher"
...
Agent Teams:
- analyst: Primary user of Deep Questioning framework
- architect: Primary user of Critical Evaluation framework
- researcher: Uses all three for comprehensive analysis
...
- analyst: Primary consumer for plan phase analysis
- researcher: Comprehensive research methodology

Skills:
- ae-foundation-philosopher: Complementary (Philosopher = strategic decisions, Thinking = creative analysis)
- ae-foundation-core: Integration with SPEC workflow
- ae-workflow-spec: Requirement documentation support

Commands:
- /ae plan: Apply thinking frameworks during specification
- /ae run: Reference during implementation decisions
