---
name: ae-platform-database-cloud
description: >
...
metadata:
  ...
  related-skills: "ae-platform-auth, ae-lang-typescript, ae-domain-backend"
...
# ae-platform-database-cloud: Cloud Database Platform Specialist
...
- ae-platform-auth for authentication integration with Supabase Auth or Firebase Auth
- ae-lang-typescript for TypeScript patterns across all platforms
- ae-lang-flutter for Firestore mobile SDK patterns
- ae-domain-backend for backend architecture with database integration
- ae-domain-mobile for mobile-first database patterns
- ae-quality-security for security best practices (RLS policies, Security Rules)

---

Status: Production Ready
Generated with: AE-ADK Skill Factory v2.0
