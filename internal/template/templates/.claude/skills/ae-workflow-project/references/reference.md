...
```python
# Integration with /ae:1-plan and /ae:3-sync
from ae_workflow_project import MoaiMenuProject

# Initialize project system
project = MoaiMenuProject("/path/to/project")

# After /ae:1-plan generates SPEC
...
from ae_workflow_project import TemplateOptimizer
...
```python
# Integrate with AE's delegation patterns
...
- Project logs: `.ae/logs/project.log`
- Template optimization logs: `.ae/logs/template-optimizer.log`
- Language initialization logs: `.ae/logs/language-init.log`
...
- AE-ADK Documentation: https://github.com/ae-adk/docs
- Claude Code Skills Guide: https://docs.anthropic.com/claude-code/skills
- SPEC-First DDD Methodology: See `ae-foundation-core/modules/spec-first-ddd.md`
