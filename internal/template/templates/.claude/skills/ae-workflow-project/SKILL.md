...
# AE Workflow Project - Integrated Project Management System
...
|---|---|
| "I'll skip /ae project on this codebase, I already know it" | /ae project produces structure.md and tech.md that future agents (and humans) rely on. Skipping it leaves a knowledge gap. |
| "Multilingual docs are a chore, I'll write English only" | language.yaml drives doc generation per project. Configuring it once is cheap and respects the team's working language. |
| "Templates are restrictive, I'll write everything from scratch" | Templates encode the conventions the project depends on. Diverging from them creates inconsistency. |
...
- structure.md or tech.md missing for a non-trivial project
- language.yaml not configured (defaults to English-only)
- Project initialized without /ae project, leading to undocumented architecture
- Templates modified without updating the template source
...
- [ ] structure.md, tech.md, and codemaps/ generated by /ae project
- [ ] language.yaml configured with conversation_language matching the team
- [ ] Templates rendered cleanly and committed
- [ ] Project metadata synced with .ae/config/sections/
