# AE Foundation Core - Modules Directory

Purpose: Extended documentation modules for ae-foundation-core skill, providing deep dives into each foundational principle.
...
This directory contains 9 comprehensive modules covering AE-ADK's foundational principles and execution rules:
...
Quick Access:
- SPEC generation (/ae:1-plan)
- EARS format patterns
- DDD implementation (/ae:2-run)
- Documentation sync (/ae:3-sync)
...
Agent Catalog - Complete reference of AE-ADK's 26 specialized agents with 7-tier hierarchy.
...
Command Catalog - Complete reference for AE-ADK's 6 core commands in SPEC-First DDD workflow.

Quick Access:
- /ae:0-project (Project init)
- /ae:1-plan (SPEC generation)
- /ae:2-run (DDD implementation)
- /ae:3-sync (Documentation)
- /ae:9-feedback (Improvement)
- /ae:99-release (Deployment)
...
skill_path = Path(".claude/skills/ae-foundation-core")
...
class ModuleSearch:
 ...
 modules_dir = Path(".claude/skills/ae-foundation-core/modules")
 results = []
...
Skills:
- ae-foundation-core (parent skill)
- ae-cc-skill-factory (skill creation)
- ae-core-agent-factory (agent creation)
