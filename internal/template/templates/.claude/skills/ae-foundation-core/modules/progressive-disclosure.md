...
TRUST 5 is AE-ADK's comprehensive quality assurance framework enforcing five pillars:
...
```bash
# 1. Generate SPEC
/ae:1-plan "Implement user authentication with JWT tokens"
...
# Validate skill
result = validator.validate_skill(".claude/skills/ae-foundation-core")
...
if not result["valid"]:
 ...
 # Auto-split
 validator.auto_split_skill(".claude/skills/ae-foundation-core")
...
# Usage
loader = ProgressiveContentLoader(".claude/skills/ae-foundation-core")
...
Skills:
- ae-foundation-modular-system - File organization patterns
- ae-foundation-token-optimization - Content efficiency
- ae-cc-skill-factory - Skill creation with progressive structure
...
Commands:
- /ae:1-plan - Generate SPEC with progressive detail
- /ae:3-sync - Create docs with layered structure
