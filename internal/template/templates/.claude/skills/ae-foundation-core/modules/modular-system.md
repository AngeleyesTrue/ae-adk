...
decision = splitter.should_split(".claude/skills/ae-foundation-core/SKILL.md")
...
if decision["split_needed"]:
 ...
 ".claude/skills/ae-foundation-core",
...
# Usage
organizer = SkillOrganizer(".claude/skills/ae-foundation-core")
...
with open(".claude/skills/ae-foundation-core/NAVIGATION.md", 'w') as f:
 f.write(navigation)
```
...
# Usage
discovery = ModuleDiscovery(".claude/skills/ae-foundation-core")
...
- ae-cc-skill-factory - Skill creation with modular structure
- ae-foundation-token-optimization - File loading efficiency
...
Commands:
- /ae:1-plan - SPEC generation with modular docs
- /ae:3-sync - Documentation sync to modular structure

Memory:
- .claude/skills/ - Standard skill location
- Skill("ae-foundation-core") modules/ - Memory files following modular pattern
