# Agents Reference - AE-ADK Agent Catalog

Purpose: Complete reference catalog of AE-ADK's 26 specialized agents with `{domain}-{role}` naming convention and 7-tier hierarchy.
...
AE delegates ALL tasks to specialized agents. 26 agents organized in 7 tiers:
...
All AE-ADK agents follow consistent naming:
...
Core command processors directly bound to AE commands.

| Agent | Command | Purpose |
|-------|---------|---------|
| `workflow-project` | `/ae:0-project` | Project initialization and setup |
| `workflow-spec` | `/ae:1-plan` | EARS SPEC generation and planning |
| `workflow-ddd` | `/ae:2-run` | DDD ANALYZE-PRESERVE-IMPROVE execution |
| `workflow-docs` | `/ae:3-sync` | Documentation generation and synchronization |
...
|-------|---------|---------|
| `core-planner` | `/ae:2-run` Phase 1 | SPEC analysis and execution strategy |
...
Meta-generation agents for AE-ADK development.
...
Use Case: When developing AE-ADK itself (not for end-user projects)
...
Note: These are Claude Code built-in agents, not AE-ADK custom agents.
...
1. Agent-First: AE NEVER executes tasks directly. ALWAYS delegates via Agent()
...
|----------|--------|---------|
| Language (Separated) | ae-lang-python, ae-lang-typescript, ae-lang-systems, ae-lang-jvm, ae-lang-mobile | Domain-specific language skills for 40-60% token savings |
| Platform (Separated) | ae-platform-auth, ae-platform-database, ae-platform-deploy | Domain-specific platform skills for 30-50% token savings |
| Foundation | ae-foundation-core, ae-foundation-claude, ae-foundation-context, ae-foundation-quality | Core principles and quality gates |
| Workflow | ae-workflow-spec, ae-workflow-project, ae-workflow-testing, ae-workflow-jit-docs | Workflow automation and testing |
| Domain | ae-domain-backend, ae-domain-frontend, ae-domain-database, ae-domain-uiux | Domain expertise patterns |

Language Skills Selection Guide:

| Language Skill | Coverage | Use When |
|----------------|----------|----------|
| ae-lang-python | Python 3.13, FastAPI, Django, pytest | Backend APIs, data science, automation |
| ae-lang-typescript | TypeScript 5.9, React 19, Next.js 16, tRPC | Frontend, full-stack web development |
| ae-lang-systems | Go 1.23, Rust 1.91, Fiber, Axum | Microservices, CLI tools, systems programming |
| ae-lang-jvm | Java 21, Kotlin 2.0, Scala 3.4, Spring | Enterprise applications, big data |
| ae-lang-mobile | Swift 6, Kotlin Android, Flutter 3.24 | iOS, Android, cross-platform mobile |

Platform Skills Selection Guide:

| Platform Skill | Providers | Use When |
|----------------|-----------|----------|
| ae-platform-auth | Auth0, Clerk, Firebase Auth | Authentication implementation |
| ae-platform-database | Supabase, Neon, Convex, Firestore | Database platform integration |
| ae-platform-deploy | Vercel, Railway | Deployment and CI/CD |

Note: Agents now use specific skills based on their domain. Cross-language agents include ae-lang-python and ae-lang-typescript by default.
...
Skills:
- [ae-foundation-core](../SKILL.md) - Parent skill (this module is part of it)
- [ae-foundation-context](../../ae-foundation-context/SKILL.md) - Token budget and session state
- [ae-foundation-claude](../../ae-foundation-claude/SKILL.md) - Claude Code configuration
...
Commands:
- `/ae:0-project` → `workflow-project`
- `/ae:1-plan` → `workflow-spec`
- `/ae:2-run` → `workflow-ddd`
- `/ae:3-sync` → `workflow-docs`
