...
SPEC-First DDD is AE-ADK's development methodology combining:

1. SPEC Generation - EARS format requirements (/ae:1-plan)
2. Domain-Driven Development - ANALYZE-PRESERVE-IMPROVE (/ae:2-run)
3. Documentation Sync - Auto-generated docs (/ae:3-sync)

Three-Phase Workflow:
```
Phase 1: SPEC → spec-builder → .ae/specs/SPEC-XXX/spec.md
...
Skills:
- ae-workflow-testing - Test frameworks

Commands:
- /ae:1-plan - SPEC generation (Phase 1)
- /ae:2-run - DDD implementation (Phase 2)
- /ae:3-sync - Documentation sync (Phase 3)
