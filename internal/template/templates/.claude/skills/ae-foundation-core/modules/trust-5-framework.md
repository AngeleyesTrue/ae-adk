...
python .ae/scripts/validate_architecture.py
...
Skills:
- ae-workflow-testing - Test framework setup
- ae-domain-security - Security patterns

Commands:
- /ae:2-run - Enforces ≥85% coverage requirement
- /ae:9-feedback - Quality improvement suggestions
