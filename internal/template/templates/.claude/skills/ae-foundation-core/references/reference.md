...
- Core Principle: AE delegates all work through Agent() calls
...
from ae_foundation_core import TRUST5Validator
...
from ae_foundation_core import SPECManager, DDDExecutor, DocsGenerator
...
from ae_foundation_core import TaskAnalyzer, AgentRouter
...
from ae_foundation_core import TokenMonitor, ContextOptimizer
...
ae-trust check --all --verbose

# Token budget analysis
ae-context analyze --show-breakdown

# Agent routing debug
ae-agent route --task "description" --dry-run

# SPEC validation
ae-spec validate SPEC-001 --format EARS
```

### Validation Utilities

```python
from ae_foundation_core import diagnose
...
- TRUST 5 logs: `.ae/logs/trust5/`
- SPEC artifacts: `.ae/specs/`
- Agent execution logs: `.ae/logs/agents/`
- Token usage history: `.ae/logs/tokens/`
...
- AE-ADK Documentation: See project README
...
- ae-workflow-project - Project management with core principles
- ae-workflow-testing - Testing workflows with TRUST 5
- ae-workflow-templates - Template management integration
