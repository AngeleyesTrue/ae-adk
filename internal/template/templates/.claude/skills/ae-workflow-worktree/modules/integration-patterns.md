...
Purpose: Overview of integration patterns for ae-worktree with AE-ADK workflow, development tools, and external systems.
...
Integration Points:
- AE-ADK Workflow: Seamless integration with /ae:1-plan, /ae:2-run, /ae:3-sync
...
The basic integration workflow follows three phases. During the Plan Phase, the /ae:1-plan command auto-creates a worktree for the SPEC. During the Development Phase, use the ae-worktree go command to navigate to the isolated environment and run /ae:2-run for DDD implementation. During the Sync Phase, use ae-worktree sync to update the worktree and /ae:3-sync for documentation synchronization.
...
AE-ADK Integration: Refer to ae-adk-integration.md
- Plan Phase integration with /ae:1-plan
- Development Phase integration with /ae:2-run
- Sync Phase integration with /ae:3-sync
...
### AE-ADK Workflow Integration

The worktree system integrates deeply with the AE Plan-Run-Sync workflow:
...
Detailed Reference: Refer to ae-adk-integration.md for complete workflow patterns
...
For automatic SPEC worktree creation, integrate with /ae:1-plan by configuring auto-creation in worktree settings. Refer to ae-adk-integration.md for implementation details.
...
For team collaboration with shared registries, configure team registry settings with developer-specific worktree prefixes. Refer to ae-adk-integration.md for coordination patterns.

---

## Sub-Module References

AE-ADK Integration (ae-adk-integration.md):
- Complete /ae:1-plan integration patterns
- DDD-aware /ae:2-run integration
- Sync Phase automation with /ae:3-sync
