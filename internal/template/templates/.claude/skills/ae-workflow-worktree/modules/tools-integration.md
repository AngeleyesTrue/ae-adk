...
Purpose: Integration patterns for ae-worktree with development tools, IDEs, terminals, CI/CD pipelines, and monitoring systems.
...
- Run Tests: Execute /ae:2-run for the SPEC
- Sync Worktree: Run ae-worktree sync command
...
- Command option completion for all ae-worktree subcommands
...
Navigation Aliases:
- mw: Short alias for ae-worktree
- mwl: List worktrees
...
- mwdev: Switch to worktree and start development with /ae:2-run
