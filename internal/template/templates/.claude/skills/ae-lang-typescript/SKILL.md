...
- ae-domain-frontend for UI components and styling patterns
- ae-domain-backend for API design and database integration
- ae-library-shadcn for component library integration
- ae-workflow-testing for testing strategies and patterns
- ae-foundation-quality for code quality standards
- ae-essentials-debug for debugging TypeScript applications
