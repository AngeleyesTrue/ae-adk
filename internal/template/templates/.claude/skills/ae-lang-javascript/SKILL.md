...
- ae-lang-typescript for TypeScript integration and type checking with JSDoc
- ae-domain-backend for API design and microservices architecture
- ae-domain-database for database integration and ORM patterns
- ae-workflow-testing for DDD workflows and testing strategies
- ae-foundation-quality for code quality standards
- ae-essentials-debug for debugging JavaScript applications
