...
metadata:
  ...
  related-skills: "ae-lang-rust, ae-domain-backend"
...
- ae-domain-backend for REST API architecture and microservices
- ae-lang-rust for systems programming companion
- ae-quality-security for security hardening
- ae-essentials-debug for performance profiling
- ae-workflow-ddd for domain-driven development
