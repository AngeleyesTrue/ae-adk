...
metadata:
  ...
  related-skills: "ae-domain-uiux, ae-domain-frontend, ae-library-shadcn, ae-lang-typescript, ae-lang-react"
...
- ae-domain-uiux: Design systems and component architecture
- ae-domain-frontend: React implementation patterns
- ae-library-shadcn: shadcn/ui component integration (Nova preset)
- ae-lang-typescript: TypeScript for generated components
- ae-lang-react: React best practices
- ae-foundation-core: SPEC-driven development workflows
