...
description: >
  ...
  or code refactoring (use ae-workflow-ddd instead).
license: Apache-2.0
...
- ae-domain-backend: Backend development workflows and API testing patterns
- ae-domain-frontend: Frontend development workflows and UI testing strategies
- ae-foundation-core: Core SPEC system and workflow management integration
- ae-platform-supabase: Supabase-specific testing patterns and database testing
- ae-platform-vercel: Vercel deployment testing and edge function validation
- ae-platform-firebase-auth: Firebase authentication testing patterns
- ae-workflow-project: Project management and documentation workflows
