...
from ae_workflow_testing import DevelopmentWorkflow, WorkflowConfig
...
from ae_workflow_testing import TDDManager, TestSpecification, TestType
...
from ae_workflow_testing import AIDebugger
...
from ae_workflow_testing import PerformanceProfiler
...
```bash
# CLI diagnostics
ae-workflow diagnose --full-check
ae-workflow test --dry-run --verbose
ae-workflow profile --list-available
ae-workflow review --show-rules

# Python diagnostics
from ae_workflow_testing import diagnose
...
- Workflow logs: `.ae/logs/workflow.log`
- Test results: `.ae/test-results/`
- Profile data: `.ae/profiles/`
- Review reports: `.ae/reviews/`
- Debug sessions: `.ae/debug-sessions/`
...
- ae-foundation-core - TRUST 5 framework and SPEC-First TDD
- ae-domain-backend - Backend development workflows
- ae-domain-frontend - Frontend development workflows
- ae-platform-baas - Backend-as-a-Service integration
