...
This modules directory contains detailed implementation modules for the ae-workflow-testing skill. Each module provides comprehensive code examples, advanced features, and integration patterns that extend the core functionality described in the main SKILL.md file.
...
from ae_workflow_testing.modules.ai_debugging import AIDebugger
from ae_workflow_testing.modules.performance_optimization import PerformanceProfiler
...
```python
from ae_workflow_testing import DevelopmentWorkflow
