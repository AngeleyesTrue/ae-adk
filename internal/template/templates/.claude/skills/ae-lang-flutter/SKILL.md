...
metadata:
  ...
  related-skills: "ae-lang-swift, ae-lang-kotlin"
...
- `ae-lang-swift` - iOS native integration for platform channels
- `ae-lang-kotlin` - Android native integration for platform channels
- `ae-domain-backend` - API integration and backend communication
- `ae-quality-security` - Mobile security best practices
- `ae-essentials-debug` - Flutter debugging and DevTools
