...
description: >
  ...
  Do NOT use for writing new tests (use ae-workflow-testing instead)
...
metadata:
  ...
  context: "fork"
  agent: "manager-ddd"
  related-skills: "ae-tool-ast-grep, ae-workflow-testing, ae-foundation-quality"
---
...
[NOTE] This workflow is selected based on `.ae/config/sections/quality.yaml`:
...
- `development_mode: tdd` → Use TDD instead (ae-workflow-tdd)
...
When executing DDD through ae:2-run in DDD mode:
...
Load ae-tool-ast-grep for detailed pattern syntax and rule creation.
