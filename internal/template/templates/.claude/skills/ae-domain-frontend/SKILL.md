...
- ae-domain-backend - Full-stack development
- ae-library-shadcn - Component library integration
- ae-domain-uiux - UI/UX design principles
- ae-lang-typescript - TypeScript patterns
- ae-workflow-testing - Frontend testing
