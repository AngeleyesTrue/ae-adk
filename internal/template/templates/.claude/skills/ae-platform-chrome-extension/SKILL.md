---
name: ae-platform-chrome-extension
description: >
...
metadata:
  ...
  related-skills: "ae-lang-typescript, ae-lang-javascript, ae-domain-frontend"
...
- ae-lang-typescript for TypeScript patterns in extension development
- ae-lang-javascript for JavaScript patterns and ES module usage
- ae-domain-frontend for React or framework-based popup and side panel UI
- ae-domain-backend for server-side API integration
- ae-workflow-testing for extension testing strategies
...
Generated with: AE-ADK Skill Factory v1.0
