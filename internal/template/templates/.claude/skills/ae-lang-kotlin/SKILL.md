...
metadata:
  ...
  related-skills: "ae-lang-java, ae-lang-swift"
...
- `ae-lang-java` - Java interoperability and Spring Boot patterns
- `ae-domain-backend` - REST API, GraphQL, microservices architecture
- `ae-domain-database` - JPA, Exposed, R2DBC patterns
- `ae-quality-testing` - JUnit 5, MockK, TestContainers integration
- `ae-infra-docker` - JVM container optimization
