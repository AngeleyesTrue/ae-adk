...
- `ae-docs-generation`: Automated documentation generation
- `ae-workflow-docs`: Documentation workflow management
- `ae-domain-frontend`: Frontend development patterns
- `ae-library-mermaid`: Diagram integration
