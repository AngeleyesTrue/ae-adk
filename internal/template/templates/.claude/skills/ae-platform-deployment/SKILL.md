...
- ae-domain-backend for backend architecture patterns
- ae-domain-frontend for frontend integration
- ae-lang-typescript for TypeScript best practices
- ae-lang-python for Python deployment (Railway)
- ae-platform-auth for authentication integration
- ae-platform-database for database patterns
