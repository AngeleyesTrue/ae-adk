...
- Skill: ae-design-tools (reference/pencil-renderer.md)
- Skill: ae-design-tools (reference/pencil-code.md)
...
- `ae-library-shadcn` - shadcn/ui component library
- `ae-code-frontend` - Frontend architecture patterns
- `ae-lang-unified` - TypeScript best practices
