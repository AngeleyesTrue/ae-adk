...
description: >
  ...
  (use ae-domain-frontend instead) or shadcn/ui specifics
  (use ae-library-shadcn instead).
license: Apache-2.0
...
For Nova preset and design presets, use ae-design-tools skill (reference/pencil-renderer.md).
...
- ae-lang-typescript - TypeScript and JavaScript best practices
- ae-foundation-core - TRUST 5 quality validation
- ae-library-nextra - Documentation generation
- ae-library-shadcn - shadcn/ui specialized patterns
...
- /ae:2-run - DDD implementation cycle
- /ae:3-sync - Documentation generation
