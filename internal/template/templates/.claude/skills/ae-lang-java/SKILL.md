...
metadata:
  ...
  related-skills: "ae-lang-kotlin, ae-domain-backend"
...
- ae-lang-kotlin for Kotlin interoperability and Spring Kotlin extensions
- ae-domain-backend for REST API, GraphQL, and microservices architecture
- ae-domain-database for JPA, Hibernate, and R2DBC patterns
- ae-foundation-quality for JUnit 5, Mockito, and TestContainers integration
- ae-infra-docker for JVM container optimization
