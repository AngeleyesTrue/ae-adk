...
Reference Skill("ae-library-nextra") for comprehensive Nextra patterns.
...
Pattern for generating documentation from AE SPEC files:
...
Skills:
- ae-library-nextra - Comprehensive Nextra documentation framework patterns
- ae-lang-python - Python docstring conventions and typing
- ae-lang-typescript - TypeScript/JSDoc documentation patterns
- ae-domain-backend - API documentation for backend services
- ae-workflow-project - Project documentation integration
...
Commands:
- /ae:3-sync - Documentation synchronization with code changes
