...
To invoke this skill, use the standard skill invocation pattern with the skill name ae-library-mermaid.
...
### Integration with AE-ADK

This skill is designed for use within Claude Code during various development phases:

During the architecture phase with the ae:1-plan command, create system design diagrams to visualize proposed solutions and component relationships.

During the documentation phase with the ae:3-sync command, generate visual documentation including flowcharts, sequence diagrams, and architecture overviews.
...
Skills that complement this skill include ae-docs-generation for comprehensive documentation generation, ae-workflow-docs for diagram validation and documentation workflows, and ae-library-nextra for architecture documentation sites.
