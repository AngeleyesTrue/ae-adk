...
#### Running Scans
```bash
# Scan with AE-ADK rules
sg scan --config .claude/skills/ae-tool-ast-grep/rules/sgconfig.yml
...
- **ae-workflow-testing** - DDD integration, test pattern detection
- **ae-foundation-quality** - TRUST 5 compliance, code quality gates
- **ae-domain-backend** - API pattern detection, security scanning
