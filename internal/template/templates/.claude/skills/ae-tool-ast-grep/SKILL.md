...
metadata:
  ...
  related-skills: "ae-workflow-testing, ae-foundation-quality, ae-domain-backend, ae-domain-frontend"
  context: "fork"
  agent: "Explore"
...
AST-Grep is integrated into AE-ADK through the Tool Registry as AST_ANALYZER type in internal/hook/registry.go, PostToolUse Hook for automatic security scanning after Write/Edit operations, and Permissions with Bash(sg:*) and Bash(ast-grep:*) auto-allowed.

### Running Scans

To scan with AE-ADK rules, execute sg scan with config pointing to .claude/skills/ae-tool-ast-grep/rules/sgconfig.yml.
...
- ae-workflow-testing: DDD integration and test pattern detection
- ae-foundation-quality: TRUST 5 compliance and code quality gates
- ae-domain-backend: API pattern detection and security scanning
- ae-domain-frontend: React/Vue pattern optimization
- ae-lang-python: Python-specific security and style rules
- ae-lang-typescript: TypeScript type safety patterns
