...
description: >
  ...
  (use ae-domain-database instead) or frontend implementation
  (use ae-domain-frontend instead).
license: Apache-2.0
...
- ae-domain-frontend - Full-stack development integration
- ae-domain-database - Advanced database patterns
- ae-foundation-core - MCP server development patterns for backend services
- ae-quality-security - Security validation and compliance
- ae-foundation-core - Core architectural principles
