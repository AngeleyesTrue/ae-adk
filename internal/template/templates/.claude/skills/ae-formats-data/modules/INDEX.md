# AE Data Format Skill Modules

This directory contains the detailed implementation modules for the ae-formats-data skill, following Claude Code's progressive disclosure pattern.
