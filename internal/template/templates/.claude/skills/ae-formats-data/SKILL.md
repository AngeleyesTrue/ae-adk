...
- ae-domain-backend - Backend data serialization and API responses
- ae-domain-database - Database data format optimization
- ae-foundation-core - MCP data serialization and transmission patterns
- ae-workflow-docs - Documentation data formatting
- ae-foundation-context - Context optimization for token budgets
