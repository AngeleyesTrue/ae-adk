...
description: >
  ...
  Do NOT use for SPEC document creation (use ae-workflow-spec instead)
...
metadata:
  ...
  aliases: "ae-workflow-templates"
  replaces: "ae-core-code-templates, ae-core-feedback-templates, ae-project-template-optimizer"
...
- Creating GitHub issues with /ae:9-feedback
- Optimizing template structures after AE-ADK updates
...
Integration: Auto-triggered by the /ae:9-feedback command.
...
Feedback Templates include Bug Report template, Feature Request template, Improvement template, Refactor template, Documentation template, Question template, and integration with /ae:9-feedback command.
...
- ae-project-config-manager: Configuration management and validation
- ae-cc-configuration: Claude Code settings integration
- ae-foundation-specs: SPEC template generation
- ae-docs-generation: Documentation template scaffolding
- ae-core-workflow: Template-driven workflows

Commands:

- /ae:0-project: Project initialization with templates
- /ae:9-feedback: Feedback template selection and issue creation
...
Feedback Submission Workflow: Execute /ae:9-feedback command, select issue type using Pattern 2, fill template fields, and auto-generate GitHub issue.
...
- v2.0.0 (2025-11-24): Unified ae-core-code-templates, ae-core-feedback-templates, and ae-project-template-optimizer into single skill with 5 core patterns
