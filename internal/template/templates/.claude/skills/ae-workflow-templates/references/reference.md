# ae-workflow-templates Reference
...
from ae_workflow_templates import TemplateManager
...
from ae_workflow_templates import TemplateOptimizer

optimizer = TemplateOptimizer("/project/.ae")
...
```python
# Integration with /ae:9-feedback command
from ae_workflow_templates import FeedbackTemplateGenerator
...
from ae_workflow_templates import VersionManager
...
- Solution: Review conflicts in `.ae/merge-conflicts/` and resolve manually
...
from ae_workflow_templates import diagnose
...
- Template storage: `.claude/skills/ae-workflow-templates/templates/`
- Backups: `.ae/backups/templates/`
- Merge conflicts: `.ae/merge-conflicts/`
- Version history: `.ae/config/template-versions.json`
- Feedback templates: `.claude/skills/ae-workflow-templates/modules/feedback-templates.md`
...
- AE-ADK Templates Guide: See `modules/code-templates.md`
- Feedback Templates Reference: See `modules/feedback-templates.md`
- Template Optimizer Guide: See `modules/template-optimizer.md`

### Related Skills

- ae-workflow-project - Project initialization with templates
- ae-foundation-core - SPEC-driven template generation
