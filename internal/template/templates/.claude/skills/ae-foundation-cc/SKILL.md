...
- Load ae-tool-ast-grep skill for complex pattern matching
...
- ae-foundation-cc: This authoring kit
- ae-foundation-core: SPEC system and workflows
- ae-foundation-philosopher: Strategic thinking
...
|---|---|
| "I'll use Bash sed instead of Edit, it is faster" | Edit is the preferred tool for accuracy and review. Bash sed errors are silent and hard to trace. |
