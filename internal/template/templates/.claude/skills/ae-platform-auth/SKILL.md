...
metadata:
  ...
  related-skills: "ae-platform-supabase, ae-platform-vercel, ae-lang-typescript, ae-domain-backend, ae-expert-security"
...
- ae-platform-supabase: Database with auth integration
- ae-platform-vercel: Deployment with edge authentication
- ae-lang-typescript: TypeScript patterns for auth SDKs
- ae-domain-backend: Backend architecture with authentication
- ae-domain-frontend: React/Next.js frontend integration
- ae-expert-security: Security audit and threat modeling
