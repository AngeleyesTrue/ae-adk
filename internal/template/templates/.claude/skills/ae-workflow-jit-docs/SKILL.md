...
- Check .ae/docs/ for project-specific documentation
- Check .ae/specs/ for requirements and specifications
...
- ae-docs-generation: Documentation generation
- ae-workflow-docs: Documentation validation
- ae-library-nextra: Nextra documentation
