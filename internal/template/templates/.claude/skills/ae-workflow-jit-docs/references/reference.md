# ae-workflow-jit-docs Reference
...
- `.ae/docs/`: Project-specific documentation
- `.ae/specs/`: Requirements and specifications
...
- `ae-docs-generation`: Generate documentation
- `ae-workflow-docs`: Documentation workflows
- `ae-library-nextra`: Nextra documentation sites
- `ae-foundation-context`: Token budget management
