...
metadata:
  ...
  related-skills: "ae-lang-kotlin, ae-lang-flutter"
...
- `ae-lang-kotlin` - Android counterpart for cross-platform projects
- `ae-lang-flutter` - Flutter/Dart for cross-platform mobile
- `ae-domain-backend` - API integration and backend communication
- `ae-foundation-quality` - iOS security best practices
- `ae-workflow-testing` - Xcode debugging and profiling
