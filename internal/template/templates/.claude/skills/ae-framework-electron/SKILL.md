...
metadata:
  ...
  related-skills: "ae-lang-typescript, ae-domain-frontend, ae-lang-javascript"
---
...
- ae-lang-typescript - TypeScript patterns for type-safe Electron development
- ae-domain-frontend - React, Vue, or Svelte renderer development
- ae-lang-javascript - Node.js patterns for main process
- ae-domain-backend - Backend API integration
- ae-workflow-testing - Testing strategies for desktop apps
