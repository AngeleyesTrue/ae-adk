...
- `ae-domain-frontend` (Frontend development patterns)
- `ae-baas-foundation` (Enterprise UI architecture)
- `ae-security-api` (UI security implementation)
- `ae-essentials-perf` (Performance optimization)
- `ae-foundation-trust` (Accessibility and compliance)
- `ae-domain-backend` (Backend integration)
- `ae-baas-vercel-ext` (Frontend deployment)
- `ae-domain-testing` (Component testing strategies)
