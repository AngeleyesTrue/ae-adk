...
- ae-domain-backend for REST API and microservices architecture
- ae-domain-database for SQL patterns and ORM optimization
- ae-workflow-testing for DDD and testing strategies
- ae-platform-deploy for Docker and deployment patterns
- ae-essentials-debug for AI-powered debugging
- ae-foundation-quality for TRUST 5 quality principles
