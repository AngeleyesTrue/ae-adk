...
See .claude/rules/ae/workflow/mx-tag-protocol.md for complete tag rules.
...
Snapshot location: $CLAUDE_PROJECT_DIR/.ae/cache/fix-snapshots/
...
Resume commands:
- /ae:fix --resume (uses latest snapshot)
- /ae:fix --resume fix-20260119-143052 (uses specific snapshot)
...
14. Save snapshot to $CLAUDE_PROJECT_DIR/.ae/cache/fix-snapshots/
