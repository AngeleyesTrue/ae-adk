...
description: >
  ...
  Supports all 16 AE-ADK languages with language-aware comment syntax.
...
For tag types, lifecycle rules, mandatory fields, and per-file limits, see: .claude/rules/ae/workflow/mx-tag-protocol.md
...
- During `/ae sync` for MX validation
...
2. **Project Context Loading**
   - Read `.ae/project/tech.md` for tech stack context
   - Read `.ae/project/structure.md` for architecture context
   - Read `.ae/project/product.md` for feature context
...
- Project context: Loaded from .ae/project/tech.md
