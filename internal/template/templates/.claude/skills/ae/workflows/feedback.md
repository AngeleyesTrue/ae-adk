...
- Description content
- Priority level
- Environment information (AE version, OS)
...
- Phase 1 collects all user input at AE orchestrator level
...
- Phase 1: AE orchestrator (AskUserQuestion for feedback collection)
