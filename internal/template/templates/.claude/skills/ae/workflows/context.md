...
When used with /ae sync or phase transitions, create git tags for session boundaries:

Tag Format: `ae/SPEC-{ID}/{phase}-complete`

Tag Message:
```
{Phase} phase completed
Decisions: N, Constraints: N, Risks: N
Next: /ae {next-phase} SPEC-{ID}
```
