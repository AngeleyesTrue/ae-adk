---
name: ae-workflow-codemaps
description: >
  Scan codebase and generate architecture documentation in .ae/project/codemaps/ directory.
...
Purpose: Scan the codebase and generate architecture documentation in `.ae/project/codemaps/` directory. Creates human-readable and AI-consumable maps of modules, dependencies, entry points, and interaction patterns.
...
- Existing .ae/project/codemaps/ content (if --force not set, for incremental updates)
...
- `.ae/project/codemaps/{area}/overview.md`
- `.ae/project/codemaps/{area}/modules.md`
- `.ae/project/codemaps/{area}/dependencies.md`
...
- Compare with existing .ae/project/codemaps/ to highlight changes (if not --force)
...
- Generate project documentation: Run /ae project to create or update product.md, structure.md, tech.md alongside the new codemaps.
- Review codemaps manually: Open the generated files in .ae/project/codemaps/ directory for manual review and editing.
...
- Phase 4: AE orchestrator (verification checks)

## Execution Summary

1. Parse arguments (extract flags: --force, --area, --format, --depth)
2. Check for existing .ae/project/codemaps/ directory content
