---
name: ae-workflow-project
description: >
  Generates project documentation from codebase analysis or user input.
  Creates product.md, structure.md, and tech.md in .ae/project/ directory,
  plus architecture maps in .ae/project/codemaps/ directory.
...
Purpose: Generate project documentation through smart questions and codebase analysis. Creates product.md, structure.md, and tech.md in .ae/project/ directory, plus architecture documentation in .ae/project/codemaps/ directory.
...
- Existing Project (Recommended): Your codebase will be automatically analyzed to generate accurate documentation. AE scans your files, architecture, and dependencies to create product.md, structure.md, and tech.md.
...
- New Project (Recommended): AE will guide you through a short interview to understand your project goals, technology choices, and key features. This creates the foundation documents for all future development.
- Existing Project: Choose this if your code exists elsewhere and you want to point AE to analyze it.
...
[HARD] During the interview, the agent MUST NOT write implementation code or generate documentation. The sole output is `.ae/project/interview.md`.

**Interview Rounds (3 rounds maximum, configured in `.ae/config/sections/interview.yaml`):**
...
**Output:** Write all answers to `.ae/project/interview.md` with this structure:
...
- Fresh Documentation: When .ae/project/ is empty, generate all three files
...
[HARD] All questions MUST use AskUserQuestion in user's conversation_language.
[HARD] During the interview, the agent MUST NOT generate documentation or write files. The sole output is `.ae/project/interview.md`.
...
- Proceed with documentation generation (Recommended): AE will generate product.md, structure.md, and tech.md based on the analysis above. You can review and edit the documents afterwards.
...
Purpose: Generate architecture documentation in `.ae/project/codemaps/` directory based on codebase analysis results from Phase 1.
...
Output Files (in `.ae/project/codemaps/` directory):
...
Goal: Automatically set the `development_mode` in `.ae/config/sections/quality.yaml` based on the project analysis results from Phase 0 and Phase 1.
...
Implementation:
- Read current `.ae/config/sections/quality.yaml`
...
- .ae/project/product.md → Project name, description, core features, target audience
- .ae/project/structure.md → Top-level directory structure, architecture pattern
- .ae/project/tech.md → Primary language, framework, key dependencies
- .ae/project/codemaps/ → Number of codemaps files generated (if any)
...
Codemaps: [N files generated] in .ae/project/codemaps/
...
- Create SPEC (Recommended): Run /ae plan to define your first feature specification. This is the natural next step after project setup.
...
- Phase 0-2: AE orchestrator (AskUserQuestion for all user interaction)
...
- Phase 3.7: AE orchestrator (automatic development_mode configuration, no user interaction)
