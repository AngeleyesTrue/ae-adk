...
Examples:
- `Use PROACTIVELY for backend architecture, API design, server implementation, database integration, or microservices architecture. Called from /ae:1-plan and task delegation workflows. CRITICAL: This agent MUST be invoked via Task(subagent_type='code-backend') - NEVER executed directly.`
...
skills: ae-lang-python, ae-domain-backend, ae-context7-integration

# Load quality and documentation skills
skills: ae-foundation-quality, ae-docs-generation, ae-cc-claude-code
```
...
---
name: code-backend
description: Use PROACTIVELY for backend architecture, API design, server implementation, database integration, or microservices architecture. Called from /ae:1-plan and task delegation workflows.
tools: Read, Write, Edit, Bash, WebFetch, Grep, Glob, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
model: sonnet
skills: ae-domain-backend, ae-essentials-perf, ae-context7-integration
---
...
---
name: format-expert
description: Use PROACTIVELY for code formatting, style consistency, linting configuration, and automated code quality improvements. Called from /ae:2-run quality gates and task delegation workflows.
tools: Read, Write, Edit, Bash, Grep, Glob
model: haiku
skills: ae-code-quality, ae-cc-configuration
---
...
---
name: workflow-ddd
description: Execute ANALYZE-PRESERVE-IMPROVE DDD cycle for implementing features with behavior preservation. Called from /ae:2-run SPEC implementation and task delegation workflows.
tools: Read, Write, Edit, Bash, Grep, Glob, MultiEdit, TodoWrite
model: sonnet
skills: ae-lang-python, ae-domain-testing, ae-foundation-quality
---
...
---
name: core-quality
description: Validate code quality against TRUST 5 framework (Testable, Readable, Unified, Secured, Trackable). Called from /ae:2-run quality validation and task delegation workflows.
tools: Read, Grep, Glob, Bash, Write, Edit
model: sonnet
skills: ae-foundation-trust, ae-code-quality, ae-security-expert
---
...
description: Use PROACTIVELY for complete application development including frontend, backend, database, and deployment. Called from /ae:2-run comprehensive implementation and task delegation workflows.
...
model: sonnet
skills: ae-domain-backend, ae-domain-frontend, ae-domain-database, ae-devops-expert, ae-security-expert
---
