...
- /ae:0-project: Initialize project structure
- /ae:1-plan: Generate SPEC document
- /ae:2-run: Execute DDD implementation
- /ae:3-sync: Generate documentation
- /ae:9-feedback: Collect improvement feedback

## Command Execution Rules

- After /ae:1-plan: Execute /clear (mandatory)
- Token threshold: Execute /clear at >150K tokens
- Error handling: Use /ae:9-feedback for all issues
```
