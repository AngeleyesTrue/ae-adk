...
description: >
  ...
  Do NOT use for writing tests (use ae-workflow-testing instead)
...
- ae-foundation-core - TRUST 5 framework reference
- ae-workflow-ddd - DDD workflow validation
- ae-security-owasp - Security compliance
- ae-context7-integration - Context7 best practices
- ae-performance-optimization - Performance analysis

Commands:

- /ae:2-run - DDD validation integration
- /ae:3-sync - Documentation quality checks
- /ae:9-feedback - Quality improvement feedback
