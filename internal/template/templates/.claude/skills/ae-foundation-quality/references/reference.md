...
Complete API reference and technical documentation for the ae-foundation-quality skill.
...
class QualityConfig:
 ...
 output_directory: str = ".ae/reports/quality"
...
This comprehensive reference documentation provides complete API coverage for the ae-foundation-quality skill, including all classes, methods, configuration options, and integration patterns needed for enterprise code quality management.
