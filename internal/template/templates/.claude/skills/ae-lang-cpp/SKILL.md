...
- `ae-lang-rust` - Systems programming comparison and interop
- `ae-domain-backend` - Backend service architecture
- `ae-workflow-testing` - DDD and testing strategies
- `ae-essentials-debug` - Debugging and profiling
- `ae-foundation-quality` - TRUST 5 quality principles
