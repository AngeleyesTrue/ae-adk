...
User Request
    ↓
/ae:1-plan "feature1" "feature2" "feature3" --worktree
    ↓
...
│ /ae:2-run │ /ae:2-run │ /ae:2-run │
└─────────────┴─────────────┴─────────────┘
    ↓
Worktree merge to main branch
    ↓
/ae:3-sync SPEC-001 SPEC-002 SPEC-003
    ↓
...
```
/ae:1-plan "database schema" --branch
    ↓
...
- AE-ADK Plan-Run-Sync Workflow: Core methodology documentation
