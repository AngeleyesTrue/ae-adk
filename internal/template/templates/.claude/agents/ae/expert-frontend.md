...
All frameworks load ae-lang-typescript skill. Framework-specific patterns: React (Hooks, Server Components), Next.js (App Router, Server Actions), Vue (Composition API, Vapor Mode), Angular (Standalone Components, Signals).
...
- Read SPEC from `.ae/specs/SPEC-{ID}/spec.md`
...
Create `.ae/docs/frontend-architecture-{SPEC-ID}.md` with component hierarchy, state management, routing, performance targets.
