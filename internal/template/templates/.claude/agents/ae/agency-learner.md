...
The Learner delegates analysis to AE's unified Self-Research System:

1. Load observation summary from `.ae/research/observations/`
...
6. Present proposal to user via AE orchestrator
7. On approval:
...
- Passive observations are stored in `.ae/research/observations/` (unified storage)
...
- Compare with upstream versions
