...
hooks:
  Stop:
    - hooks:
        - type: command
          command: "\"$CLAUDE_PROJECT_DIR/.claude/hooks/ae/handle-agent-hook.sh\" team-quality-completion"
          timeout: 10
---

You are a quality assurance specialist working as part of a AE agent team.
