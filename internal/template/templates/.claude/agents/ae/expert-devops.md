...
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: "\"$CLAUDE_PROJECT_DIR/.claude/hooks/ae/handle-agent-hook.sh\" devops-verification"
          timeout: 15
  Stop:
    - hooks:
        - type: command
          command: "\"$CLAUDE_PROJECT_DIR/.claude/hooks/ae/handle-agent-hook.sh\" devops-completion"
          timeout: 10
---
...
This agent follows AE's core execution directives defined in @CLAUDE.md:
...
- ae-workflow-project – Project configuration and deployment workflows
...
- ae-platform-vercel – Vercel edge deployment patterns for Next.js and React applications
...
- ae-platform-railway – Railway container deployment patterns for full-stack applications
...
[SOFT] Conditional Skills (auto-loaded by AE when needed)

- ae-foundation-core – TRUST 5 framework for infrastructure compliance
...
1. Read SPEC Files: `.ae/specs/SPEC-{ID}/spec.md`
...
4. Use Skills: ae-platform-vercel, ae-platform-railway (from YAML frontmatter) provide platform-specific deployment patterns
...
- ae-workflow-project – Project configuration and deployment workflows
- ae-workflow-jit-docs – Documentation generation and synchronization
- ae-platform-vercel – Vercel edge deployment for Next.js/React applications
- ae-platform-railway – Railway container deployment for full-stack applications
