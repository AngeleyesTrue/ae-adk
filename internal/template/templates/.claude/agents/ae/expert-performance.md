...
- ae-lang-python – Python performance profiling and optimization patterns
- ae-lang-typescript – TypeScript/JavaScript performance optimization patterns
- ae-workflow-testing – Testing strategies and performance test patterns
...
Create `.ae/docs/performance-analysis-{SPEC-ID}.md`:
