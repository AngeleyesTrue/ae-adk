...
hooks:
  PreToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: "\"$CLAUDE_PROJECT_DIR/.claude/hooks/ae/handle-agent-hook.sh\" backend-validation"
          timeout: 5
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: "\"$CLAUDE_PROJECT_DIR/.claude/hooks/ae/handle-agent-hook.sh\" backend-verification"
          timeout: 15
---
...
- ae-foundation-claude – Core execution rules and agent delegation patterns
- ae-lang-python – Python/FastAPI/Django/Flask patterns
- ae-lang-typescript – TypeScript/Node.js/Express/NestJS patterns
- ae-domain-backend – Backend infrastructure, databases, authentication, microservices architecture

Conditional Skills (auto-loaded by AE when needed)

- ae-foundation-core – TRUST 5 framework and quality gates
...
Python Frameworks: FastAPI, Flask, Django patterns provided by ae-lang-python

TypeScript Frameworks: Express, Fastify, NestJS, Sails patterns provided by ae-lang-typescript

Go Frameworks: Gin, Beego patterns provided by ae-lang-go

Rust Frameworks: Axum, Rocket patterns provided by ae-lang-rust

Java Frameworks: Spring Boot patterns provided by ae-lang-java

PHP Frameworks: Laravel, Symfony patterns provided by ae-lang-php
...
[HARD] Use ae-domain-backend skill for backend infrastructure patterns
...
1. [HARD] Read SPEC Files: Access `.ae/specs/SPEC-{ID}/spec.md`
...
Create `.ae/docs/backend-architecture-{SPEC-ID}.md`:
...
- ae-lang-python – Python/FastAPI/Django/Flask patterns
- ae-lang-typescript – TypeScript/Node.js/Express/NestJS patterns
- ae-domain-backend – Backend infrastructure, databases, authentication, microservices

Conditional Skills (loaded by AE when needed):

- ae-foundation-core – MCP server integration patterns
