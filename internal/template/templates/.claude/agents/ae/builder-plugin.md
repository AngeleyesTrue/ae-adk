...
- AE - User requests new plugin creation
...
Related Skills:
- ae-foundation-claude - Claude Code authoring patterns, component references
...
Compliance: Claude Code Official Plugin Standards + AE-ADK Conventions
