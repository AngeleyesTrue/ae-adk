...
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: "\"$CLAUDE_PROJECT_DIR/.claude/hooks/ae/handle-agent-hook.sh\" testing-verification"
          timeout: 15
  Stop:
    - hooks:
        - type: command
          command: "\"$CLAUDE_PROJECT_DIR/.claude/hooks/ae/handle-agent-hook.sh\" testing-completion"
          timeout: 10
---
...
- ae-lang-python – Python/pytest/unittest testing patterns
- ae-lang-typescript – TypeScript/Jest/Vitest/Playwright testing patterns
- ae-workflow-testing – Testing strategies and comprehensive test patterns
- ae-foundation-quality – Quality gates and TRUST 5 framework

Conditional Skills (auto-loaded by AE when needed)
- ae-foundation-core – SPEC integration and workflow patterns
...
Create `.ae/docs/test-strategy-{SPEC-ID}.md`:
...
- ae-lang-python – Python/pytest/unittest testing patterns
- ae-lang-typescript – TypeScript/Jest/Vitest/Playwright testing patterns
- ae-workflow-testing – Comprehensive testing strategies and patterns
- ae-foundation-quality – Quality gates and TRUST 5 framework

Conditional Skills (loaded by AE when needed):
- ae-workflow-testing – Testing patterns and automation workflows
