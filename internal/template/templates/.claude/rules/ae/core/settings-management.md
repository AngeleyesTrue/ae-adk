---
paths: "**/.ae/config/**,**/.mcp.json,**/.claude/settings.json,**/.claude/settings.local.json"
---

# Settings Management

Claude Code and AE configuration management rules.
...
Standard MCP servers in AE-ADK:
...
`.ae/config/` - AE-specific settings:
...
Team behavior is controlled by the `workflow.team` section in `.ae/config/sections/workflow.yaml`:
