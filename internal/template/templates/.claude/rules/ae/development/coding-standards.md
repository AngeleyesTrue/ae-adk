...
AE-specific coding standards. General coding conventions are not included as Claude already knows them.
...
- Configuration files (.ae/config/**/*.yaml)
...
- Move detailed content to .claude/rules/ae/
