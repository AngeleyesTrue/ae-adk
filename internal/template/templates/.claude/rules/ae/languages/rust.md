...
- `ae-lang-go` - Go systems programming patterns
- `ae-domain-backend` - REST API architecture and microservices patterns
- `ae-foundation-quality` - Security hardening for Rust applications
- `ae-workflow-testing` - Test-driven development workflows
