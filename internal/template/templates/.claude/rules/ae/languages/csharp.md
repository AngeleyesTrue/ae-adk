...
- `ae-domain-backend` - API design, database integration patterns
- `ae-platform-deploy` - Azure, Docker, Kubernetes deployment
- `ae-workflow-testing` - Testing strategies and patterns
- `ae-foundation-quality` - Code quality standards
- `ae-essentials-debug` - Debugging .NET applications
