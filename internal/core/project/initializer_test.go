...
func TestInit_BasicInitialization(t *testing.T) {
	...
	for _, dir := range aeDirs {
		dirPath := filepath.Join(root, ".ae", dir)
	...
	// Verify config files
	assertFileExists(t, filepath.Join(root, ".ae", "config", "sections", "user.yaml"))
	assertFileExists(t, filepath.Join(root, ".ae", "config", "sections", "language.yaml"))
	assertFileExists(t, filepath.Join(root, ".ae", "config", "sections", "quality.yaml"))
	assertFileExists(t, filepath.Join(root, ".ae", "config", "sections", "workflow.yaml"))
...
func TestInit_UserYAMLContent(t *testing.T) {
	...
	// Verify user.yaml
	userPath := filepath.Join(root, ".ae", "config", "sections", "user.yaml")
...
func TestInit_LanguageYAMLContent(t *testing.T) {
	...
	langPath := filepath.Join(root, ".ae", "config", "sections", "language.yaml")
...
func TestInit_QualityYAMLContent(t *testing.T) {
	...
	qualityPath := filepath.Join(root, ".ae", "config", "sections", "quality.yaml")
...
func TestInit_NoDynamicTokensInGeneratedFiles(t *testing.T) {
	...
	files := []string{
		filepath.Join(root, ".ae", "config", "sections", "user.yaml"),
		filepath.Join(root, ".ae", "config", "sections", "language.yaml"),
		filepath.Join(root, ".ae", "config", "sections", "quality.yaml"),
...
func TestInit_YAMLFilesAreParseable(t *testing.T) {
	...
	yamlFiles := []string{
		...
		filepath.Join(root, ".ae", "config", "sections", "language.yaml"),
		filepath.Join(root, ".ae", "config", "sections", "quality.yaml"),
		filepath.Join(root, ".ae", "config", "sections", "workflow.yaml"),
	}
...
func TestInit_ManifestIsValidJSON(t *testing.T) {
	...
	manifestPath := filepath.Join(root, ".ae", "manifest.json")
...
func TestInit_WorkflowYAMLContent(t *testing.T) {
	...
	workflowPath := filepath.Join(root, ".ae", "config", "sections", "workflow.yaml")
