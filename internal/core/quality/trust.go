...
// matching the .ae/config/sections/quality.yaml specification.
...
// @MX:ANCHOR: [AUTO] 17개 파일에서 참조하는 TRUST 5 품질 검증 핵심 메서드
// @MX:REASON: 변경 시 wizard, workflow, PR reviewer 등 전체 품질 게이트에 영향
