...
func TestEnvRankEnabled_ExplicitTrue(t *testing.T) {
	t.Setenv("AE_RANK_ENABLED", "true")
	if !EnvRankEnabled() {
		t.Error("expected true when AE_RANK_ENABLED=true")
	}
}

func TestEnvRankEnabled_ExplicitFalse(t *testing.T) {
	t.Setenv("AE_RANK_ENABLED", "false")
	if EnvRankEnabled() {
		t.Error("expected false when AE_RANK_ENABLED=false")
	}
}

func TestEnvRankEnabled_One(t *testing.T) {
	t.Setenv("AE_RANK_ENABLED", "1")
	if !EnvRankEnabled() {
		t.Error("expected true when AE_RANK_ENABLED=1")
	}
}

func TestEnvRankEnabled_Zero(t *testing.T) {
	t.Setenv("AE_RANK_ENABLED", "0")
	if EnvRankEnabled() {
		t.Error("expected false when AE_RANK_ENABLED=0")
	}
}

func TestEnvRankEnabled_InvalidValue(t *testing.T) {
	t.Setenv("AE_RANK_ENABLED", "not-a-bool")
	if !EnvRankEnabled() {
...
func TestEnvRankTimeout_InvalidValue(t *testing.T) {
	t.Setenv("AE_RANK_TIMEOUT", "not-a-number")
	got := EnvRankTimeout()
	if got != 10*time.Second {
