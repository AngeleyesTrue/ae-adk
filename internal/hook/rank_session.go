...
// Set AE_RANK_ENABLED=false to disable rank session submission.
func EnvRankEnabled() bool {
	val := os.Getenv("AE_RANK_ENABLED")
	if val == "" {
...
// Defaults to 10 seconds. Set AE_RANK_TIMEOUT to customize.
func EnvRankTimeout() time.Duration {
	val := os.Getenv("AE_RANK_TIMEOUT")
	if val == "" {
