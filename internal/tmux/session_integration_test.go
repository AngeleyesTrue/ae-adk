...
func TestIntegration_TmuxSessionWithMultiplePanes(t *testing.T) {
	...
	cfg := &SessionConfig{
		...
		Panes: []PaneConfig{
			{SpecID: "SPEC-ISSUE-1", Command: "ae worktree go SPEC-ISSUE-1"},
			{SpecID: "SPEC-ISSUE-2", Command: "ae worktree go SPEC-ISSUE-2"},
			{SpecID: "SPEC-ISSUE-3", Command: "ae worktree go SPEC-ISSUE-3"},
			{SpecID: "SPEC-ISSUE-4", Command: "ae worktree go SPEC-ISSUE-4"},
		},
		MaxVisible: 2,
	}
