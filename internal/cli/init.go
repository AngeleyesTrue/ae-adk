...
var initCmd = &cobra.Command{
	...
	Short:   "Initialize a new AE project",
	GroupID: "project",
	Long: `Initialize a new AE project with Claude Code integration.

Usage patterns:
  ae init <project-name>   Create a new folder and initialize inside it
  ae init .                Initialize in current directory
...
func init() {
	...
	initCmd.Flags().String("mode", "", "Development mode: ddd or tdd (default: tdd, auto-configured by /ae project)")
...
func runInit(cmd *cobra.Command, args []string) error {
	...
	// - ae init <name>  → create ./name/ directory
	// - ae init .       → use current directory
	// - ae init         → use current directory
	cwd, err := os.Getwd()
	if err != nil {
	...
	_, _ = fmt.Fprintln(cmd.OutOrStdout(), "Initializing AE project...") //nolint:errcheck
	...
	_, _ = fmt.Fprintln(cmd.OutOrStdout(), renderSuccessCard("AE project initialized", details...))
